...
public class compiladorLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LETRA", "DIGITO", "PA", "PC", "LLA", "LLC", "CA", "CC", "PYC", "COMA", 
			"ASIG", "SUMA", "RESTA", "MULT", "DIV", "MOD", "MASIG", "RESIG", "MULASIG", 
			"DIVASIG", "MODASIG", "MENOR", "MAYOR", "MENOREQ", "MAYOREQ", "EQUAL", 
			"NEQUAL", "NUMERO", "INT", "DOUBLE", "IF", "ELSE", "FOR", "WHILE", "RETURN", 
